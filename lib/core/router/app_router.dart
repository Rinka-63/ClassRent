...
import '../../features/payments/presentation/screens/payment_detail_admin_screen.dart';
import '../../features/payments/presentation/screens/payment_detail_screen.dart';
import '../../features/payments/presentation/screens/payment_management_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoutes.adminPaymentDetail,
        builder: (_, state) => PaymentDetailAdminScreen(
          paymentId: state.pathParameters['paymentId']!,
        ),
      ),
      GoRoute(
